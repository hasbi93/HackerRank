/*
 * Solutions to http://sqlzoo.net/wiki/SELECT_from_WORLD_Tutorial
 *
 * Covers previously-introduced conditionals, ROUND, LENGTH, and LEFT.
 */
...
-- 7) Show the countries that are big by area (> 3 million sq km) or big
--    by population. (> 250 million). Show name, population and area.
...
-- 9) For countries in 'South America', show population in millions and 
...
-- 10) Show per-capita GDP for the trillion dollar countries to the
--     nearest $1000.
...
--     Don't include countries where the name and the capital are the 
--     same word.
