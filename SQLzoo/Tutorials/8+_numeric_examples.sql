/*
 * Solutions to https://sqlzoo.net/wiki/NSS_Tutorial
 *
 * Doesn't cover any new material; just provides more practice.
 */

 
-- 1) The example shows the number who responded for question 1 at 
--    'Edinburgh Napier University' studying '(8) Computer Science'.
...
--    for each of the subjects '(8) Computer Science' and '(H) Creative Arts 
--    and Design'.
...
SELECT subject,
  ...
  GROUP BY subject;
       ...
       /*
        * If you round the approximate number of students, the answer is "wrong"
        */
