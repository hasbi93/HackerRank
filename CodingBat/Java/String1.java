/*
 * Solutions to all problems at https://codingbat.com/java/String-1
 *
...
/* theEnd *********************************************************************/
    ...
    public String theEnd(String str, boolean front) {
        int subStart;
        subStart = (front ? 0 : str.length() - 1);
        return str.substring(subStart, subStart + 1);
    }
...
/* lastChars ******************************************************************/
    ...
    public String lastChars(String a, String b) {
        ...
        String bFirst = b.length() == 0 ? "@" : b.substring(b.length() - 1);
...
/* seeColor *******************************************************************/
    ...
    public String seeColor(String str) {
        String[] targets = { "red", "blue" };
        for (String target : targets) {
            if (str.length() >= target.length()
                    && str.substring(0, target.length()).equals(target)) {
                return target;
            }
        }
        return "";
...
/* minCat *********************************************************************/
     ...
     * string. So "Hello" and "Hi" yield "loHi". The strings may be
     * any length. */

    public String minCat(String a, String b) {
        String shorter = a.length() < b.length() ? a : b;
        String longer = shorter.equals(a) ? b : a;
        String longerSub = longer.substring(longer.length() - shorter.length());
        if (shorter.equals(a)) {
            return shorter + longerSub;
        } else {
            return longerSub + shorter;
        }
    }
...
/* deFront ********************************************************************/
     ...
     * the first char if it is 'a' and keep the second char if it is 'b'.
...
/* startWord ******************************************************************/
     ...
     * string "hippo" the word "hi" returns "hi" and "xip" returns "hip".
